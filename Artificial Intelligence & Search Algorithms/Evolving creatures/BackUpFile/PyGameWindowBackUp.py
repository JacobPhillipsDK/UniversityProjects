...
class WindowApp:
    ...
    def __init__(self, width: int, height: int, title: str):
        ...
        self.mutate = 0.50  # Mutation rate
        self.elitism = .80  # elitism (selection bias)
        self.generation_time = 200  # Generation length in seconds
    ...
    def update(self):  # Update game state
        ...
        for gen in range(0, self.generation):
            ...
            self.simulate(foods=self.list_of_food, gen=self.generation, creatures=self.list_of_Bobs)
